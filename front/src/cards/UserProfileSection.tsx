...
export default function ProfileEditor(): React.JSX.Element {
  ...
  function validate(): boolean {
    ...
    if (form.password) {
      ...
      if (!/[0-9]/.test(form.password))
        next.password = (next.password ? next.password + ", " : "") + "Doit contenir un chiffre";
      if (!/[A-Z]/.test(form.password))
        next.password = (next.password ? next.password + ", " : "") + "Doit contenir une majuscule";
    }
  ...
  function openEditModal(user: User) {
    ...
    setUserForm({ name: user.name, email: user.email, department: user.department, role: user.role });
        ...
        <header className="flex items-center gap-6 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500">
              Modifie ton nom, email ou mot de passe ici.
            </p>
          </div>
        ...
        <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              className={`w-full rounded-lg border px-3 py-2 focus:ring-2 ${
                errors.name ? "border-red-400 focus:ring-red-300" : "border-gray-200 focus:ring-sky-300"
              }`}
            />
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              className={`w-full rounded-lg border px-3 py-2 focus:ring-2 ${
                errors.email ? "border-red-400 focus:ring-red-300" : "border-gray-200 focus:ring-sky-300"
              }`}
            />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2 pr-10 focus:ring-2 ${
                  errors.password ? "border-red-400 focus:ring-red-300" : "border-gray-200 focus:ring-sky-300"
                }`}
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full rounded-lg border px-3 py-2 pr-10 focus:ring-2 ${
                  errors.confirm ? "border-red-400 focus:ring-red-300" : "border-gray-200 focus:ring-sky-300"
                }`}
              />
              <button
                type="button"
      ...
      >
        <header className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-lg font-semibold flex items-center gap-2">
              <Users size={20} className="text-sky-600" /> Gestion des utilisateurs
            </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Rechercher nom, email ou département..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-10 pr-3 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-sky-500"
            />
          </div>
          <select
            value={filterRole}
            onChange={(e) => setFilterRole(e.target.value as "all" | "admin" | "utilisateur")}
            className="px-3 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-sky-500"
          >
          ...
          {filteredUsers.length === 0 ? (
            ...
            filteredUsers.map((user) => (
              <motion.div
                ...
                className="bg-gray-50 rounded-lg p-4 border border-gray-100 hover:border-gray-200 transition flex justify-between items-start"
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                    <span>
                      <strong>Dépt :</strong> {user.department}
                    </span>
                    <span>
                      <strong>Ajouté :</strong> {user.createdAt}
                    </span>
                  </div>
                </div>
        ...
        {/* Stats */}
        <div className="mt-4 pt-4 border-t border-gray-200 grid grid-cols-3 text-center gap-4">
          <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-sky-500"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select
                    value={userForm.role}
                    onChange={(e) =>
                      setUserForm({ ...userForm, role: e.target.value as "admin" | "utilisateur" })
                    }
                    className="w-full rounded-lg border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-sky-500"
                  >
                    <option value="utilisateur">Utilisateur</option>
