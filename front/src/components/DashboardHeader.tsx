...
// Importation des utilitaires de date
 ...
 */
// Types de sévérité des notifications
...
/**
 * Interface définissant le contexte de gestion des notifications
 */
      ...
      <div className="relative">
        ...
        <div className="relative p-2">
          <div className="flex justify-between items-center">
            {/* === TITRE === */}
            <div className="ml-2">
              <h1 className="text-lg font-semibold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
                Dashboard 
              </h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="p-1 hover:bg-white/20 h-7">
